...
public class FeedListActivitynologin extends AppCompatActivity {
    ...
    public void updateList() {
        ...
        feedListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> a, View v, int position,	long id) {
                ...
                Intent intent = new Intent(FeedListActivitynologin.this, FeedDetailsActivity.class);
...
//					}
    ...
    private int getCount() {
        count--;
        if (count == 0) {
            Intent intent = new Intent(this, Proverbnologin.class);
            startActivity(intent);
            finish();
        }
//        for(int i = 9;i>=0;i--){
...
//        return super.onOptionsItemSelected(item);
    ...
    public void openSettings(MenuItem item){
        ...
        intent.setClass(FeedListActivitynologin.this, SettingActivity.class);
        startActivity(intent);
