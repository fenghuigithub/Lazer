...
public class FBLogin extends ActionBarActivity implements View.OnClickListener{
...
//    public static final int INDEX_CUSTOM_LOGIN = 1;
    ...
    public static FBLogin ma;
    public Button nologin;
    ...
    public void onClick(View v){
        ...
        intent.setClass(FBLogin.this,Userpreferencenologin.class);
